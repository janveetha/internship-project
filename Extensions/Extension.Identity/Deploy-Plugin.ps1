# Deploy-Plugin.ps1
# Builds (publish) and deploys the Identity extension to the host's plugin folder,
# then verifies the isolated dependencies are present in the output.

param(
    [string]$PluginId    = "identity",
...
$projectDir  = "NodeConfigurator.Extensions.Identity"
$project     = Join-Path $projectDir "NodeConfigurator.Extensions.Identity.csproj"
